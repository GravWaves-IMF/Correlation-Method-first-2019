...
5. Run the [PltCorrVsGPSTime.ipynb](https://github.com/GravWaves-IMF/Correlation-Method-first-2019-/blob/master/Code/PltCorrVsGPSTime.ipynb) to plot the [GW*event-name*CorrVsTime.png](https://raw.githubusercontent.com/GravWaves-IMF/Correlation-Method-first-2019-/master/Code/GW150914/GW150914CorrVsTime.png?token=AFQOQTNWQSTT6INIMW5PN2S57DOCY) and find the _GPS_ Time of the max strain correlation.
